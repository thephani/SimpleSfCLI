...
describe('AuthService', () => {
	...
	describe('authenticate', () => {
		...
		it('should handle JWT signing errors', async () => {
			...
			await expect(service.authenticate()).rejects.toThrow('Authentication error: Invalid key');
		});
		...
		it('should handle failed authentication', async () => {
			...
			await expect(service.authenticate()).rejects.toThrow('Authentication error: Authentication failed: 401');
		});
	});
    ...
    describe('AuthService', () => {
        ...
        it('should handle failed token retrieval', async () => {
			...
			await expect((service as any).getAccessToken(MOCK_JWT_TOKEN)).rejects.toThrow('Authentication failed: 403');
		});
